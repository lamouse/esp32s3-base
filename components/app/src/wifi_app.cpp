...
#define EXAMPLE_ESP_MAXIMUM_RETRY 3
    ...
    static void mask_event_cb(lv_event_t *e)
    {
        ...
        else if (code == LV_EVENT_DRAW_MAIN_BEGIN)
        {
            ...
            lv_draw_mask_fade_param_t *fade_mask_top = static_cast<lv_draw_mask_fade_param_t *> (lv_mem_buf_get(sizeof(lv_draw_mask_fade_param_t)));
            ...
            lv_draw_mask_fade_param_t *fade_mask_bottom = static_cast<lv_draw_mask_fade_param_t *>(lv_mem_buf_get(sizeof(lv_draw_mask_fade_param_t)));
            lv_draw_mask_fade_init(fade_mask_bottom, &rect_area, LV_OPA_COVER, rect_area.y1, LV_OPA_TRANSP, rect_area.y2);
            mask_bottom_id = lv_draw_mask_add(fade_mask_bottom, NULL);
        }
        else if (code == LV_EVENT_DRAW_POST_END)
        {
            lv_draw_mask_fade_param_t *fade_mask_top = static_cast<lv_draw_mask_fade_param_t *>(lv_draw_mask_remove_id(mask_top_id));
            lv_draw_mask_fade_param_t *fade_mask_bottom = static_cast<lv_draw_mask_fade_param_t *>(lv_draw_mask_remove_id(mask_bottom_id));
